...
@section('title', 'Paket GNet - GNS Admin')
...
@section('content')
    ...
    {{-- Satu Card Utama untuk Seluruh Konten Halaman --}}
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Manajemen Paket Internet Gnet</h5>
            ...
            <div class="row" id="packageList">
                ...
                @empty
                    <div class="col-12">
                        <p class="text-center text-muted">Belum ada paket yang ditambahkan.</p>
                    </div>
                @endforelse
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('packages.store') }}" method="POST">
                        @csrf
                        <input type="hidden" name="type" value="gnet">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="packageBenefits" name="benefits" placeholder="Contoh: Browsing, Streaming, Tanpa FUP" required>
                        </div>
...
@push('scripts')
    ...
    {{-- <script src="{{ asset('js/gnet.js') }}"></script> --}}
@endpush