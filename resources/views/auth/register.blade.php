...
<head>
  ...
  <title>Register - GNS Admin</title>
          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                {{-- PERBAIKAN: Menyesuaikan form untuk Laravel --}}
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-3">
                        ...
                        {{-- PERBAIKAN: Menambahkan 'name', 'value', dan error handling --}}
                    ...
                    {{-- PERBAIKAN PENTING: Menambahkan input Konfirmasi Password --}}
                    <div class="mb-4">
                        <label for="password_confirmation" class="form-label">Confirm Password</label>
                        <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" required>
                    </div>

                    {{-- PERBAIKAN: Mengubah <a> menjadi <button type="submit"> --}}
                    <button type="submit" class="btn btn-primary w-100 py-8 fs-4 mb-4">Sign Up</button>
                    
                    <div class="d-flex align-items-center justify-content-center">
                        <p class="fs-4 mb-0 fw-bold">Already have an Account?</p>
                        {{-- PERBAIKAN: Menggunakan route() untuk link dinamis --}}
